...
class Date extends \DateTimeImmutable
{
     ...
     */
    public static function createFrom(string $date, \DateTimeZone|null $timezone = null): static
    {
        return static::from($date, $timezone);
    }

    public static function from(string $date, \DateTimeZone|null $timezone = null): static
    {
