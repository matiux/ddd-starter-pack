...
class DateTimeRFC extends \DateTimeImmutable
{
    ...
    final public function __construct(string $datetime = 'now', \DateTimeZone|null $timezone = null)
    {
     ...
     */
    public static function createFrom(string $dateTime, \DateTimeZone|null $timezone = null): static
    {
        return self::from($dateTime, $timezone);
    }

    public static function from(string $dateTime, \DateTimeZone|null $timezone = null): static
    {
