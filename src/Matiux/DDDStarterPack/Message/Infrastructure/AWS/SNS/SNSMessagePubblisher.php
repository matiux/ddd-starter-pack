...
namespace DDDStarterPack\Message\Infrastructure\AWS\SNS;

use Aws\Sns\SnsClient;
use BadMethodCallException;
use DateTimeInterface;
use DDDStarterPack\Message\Application\BasicMessageService;
use DDDStarterPack\Message\Application\Configuration\Configuration;
use DDDStarterPack\Message\Application\Configuration\ConfigurationValidator;
...
use DDDStarterPack\Message\Infrastructure\AWS\AWSBasicService;
use DDDStarterPack\Message\Infrastructure\AWS\AWSMessage;
use DDDStarterPack\Message\Infrastructure\AWS\AWSMessageProducerResponse;
use DDDStarterPack\Message\Infrastructure\AWS\SNS\Configuration\SNSConfiguration;
use DDDStarterPack\Message\Infrastructure\AWS\SNS\Configuration\SNSConfigurationValidator;
